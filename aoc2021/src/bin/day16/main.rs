...
fn read_packets_by_length(mut input: String, mut length: usize) -> i32 {
...
fn read_packets_by_count(mut input: &mut String, mut count: usize) -> (i32, usize) {
...
fn part2(input: &Vec<String>) -> i32 {
    let mut input = decode(&input[0]);
    let length = input.len();
    read_packets_by_count_part2(&mut input, 1)[0]
}
